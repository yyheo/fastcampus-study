...
export default function AddressSearch({
  ...
  return (
    <>
        ...
        <div className="mt-2">
          <div className="grid grid-cols-3 md:grid-cols-6 gap-6">
            ...
            <button
              ...
              className="bg-blue-700 hover:bg-blue-600 rounded text-white py-1.5 px-2"
            >
              주소 검색
            </button>
          </div>
      ...
      {isOpen && (
        <div className="border border-gray-300 w-full md:col-span-3 col-span-full rounded-md p-2 my-3">
